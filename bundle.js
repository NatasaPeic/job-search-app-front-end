...
/***/ function(module, exports, __webpack_require__) {
	...
	// create job
	var showCreateJobModal = function showCreateJobModal() {
	  $('#create-job-modal').modal('show');
	};

	var closeCreateJobModal = function closeCreateJobModal() {
	  $('#create-job-modal').modal('hide');
	};

	var onCreateJobs = function onCreateJobs(event) {
	  event.preventDefault();
	...
	// update job
	var showUpdateJobModal = function showUpdateJobModal() {
	  $('#update-job-modal').modal('show');
	};

	var closeUpdateJobModal = function closeUpdateJobModal() {
	  $('#update-job-modal').modal('hide');
	};

	var onUpdateJobs = function onUpdateJobs(event) {
	  event.preventDefault();

	  var data = getFormFields(this);
	  var id = $('#update-jobID').val();
	  // debugger;
	...
	var onDeleteJobs = function onDeleteJobs(event) {
	  event.preventDefault();

	  var id = $('#delete-jobID').val();
	  // debugger;
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#update-job').on('submit', function (event) {
	    event.preventDefault();
	    var id = $(".update-job-btn").attr("data-job-id");
	    var data = getFormFields(this);
	    // debugger;
	    api.updateJob(ui.updateJobSuccess, ui.failure, data, id);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createJob = function createJob(success, failure, data) {
	  $.ajax({
	    method: "POST",
	    url: app.api + '/jobs',
	    data: data,
	...
	var getJobs = function getJobs(success, failure) {
	  return $.ajax({
	    url: app.api + '/jobs',
	    dataType: 'json',
	    method: "GET",
	...
	var deleteJob = function deleteJob(success, failure, job_id) {
	  $.ajax({
	...
	var updateJob = function updateJob(success, failure, data, job_id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// handlebars
	var displayJobs = function displayJobs(jobs) {
	  // debugger;
	  var jobListingTemplate = __webpack_require__(8);
	...
	var showJobsSuccess = function showJobsSuccess(data) {
	...
	// delete
	var deleteJobSuccess = function deleteJobSuccess(data) {
	  console.log(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.jobs : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var alias1=container.lambda, alias2=container.escapeExpression;

	  return "\n\n  <tr>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.company_name : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.position_name : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\"><a href=\""
	    + alias2(alias1((depth0 != null ? depth0.company_url : depth0), depth0))
	    + "\" target=\"_blank\">"
	    + alias2(alias1((depth0 != null ? depth0.company_url : depth0), depth0))
	    + "</a></td>\n    <td style=\"padding:10px;\"><a href=\""
	    + alias2(alias1((depth0 != null ? depth0.application_url : depth0), depth0))
	    + "\" target=\"_blank\">"
	    + alias2(alias1((depth0 != null ? depth0.application_url : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.requirements : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.salary : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.notes : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.applied : depth0), depth0))
	    + "</td>\n    <td style=\"padding:10px;\">"
	    + alias2(alias1((depth0 != null ? depth0.contact : depth0), depth0))
	    + "</td>\n    <td><button type=\"button\" class=\"btn btn-success update-job\" data-job-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#update-job-modal\">Update</button></td>\n    <td><button type=\"button\" class=\"btn btn-warning delete-job\" data-job-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#delete-job-modal\">Delete</button></td>\n\n  </tr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(28),depth0,{"name":"partial","data":data,"indent":"     ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<!-- I can't overwrite damn Bootstrap styleshes, so I had to use inline td styling -->\n\n<tr class=\"table-top-row\">\n  <td style=\"data-label: Position; padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Position</td>\n  <td style=\"data-label: Company name;padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Company</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Company URL</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Application URL</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Requirements</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Salary  (K)</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Notes</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Applied</td>\n  <td style=\"padding:10px; width: 150px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">Contacts</td>\n  <td style=\"padding:10px; width: 100px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">DELETE JOB</td>\n  <td style=\"padding:10px; width: 100px; background-color: #264d00; color: white; font-size: 20px; font-family: inherit; \">UPDATE JOB</td>\n\n</tr>\n";
	},"useData":true});

...
/***/ function(module, exports, __webpack_require__) {
	...
	// delete
	var showDeleteJobModal = function showDeleteJobModal() {
	  $('#c-job-modal').modal('show');
	};

	var closeDeleteJobModal = function closeDeleteJobModal() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateJob = function updateJob(success, failure, data, id) {
	...
	var deleteJob = function deleteJob(success, failure, id) {
	  $.ajax({
	    url: app.api + '/jobs/' + id,
	    method: 'DELETE',
	    headers: {
